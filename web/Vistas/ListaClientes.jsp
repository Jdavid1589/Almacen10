...
<html>
    ...
    <head>
        ...
        <!-- Funsion Para el BTN /agregar/Actualizar -->
        <script>
                ...
                <div class="col-sm-5">
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <form id="formAgregarProducto" action="ControladorFacturaventa" method="POST" autocomplete="off" class="formulario">
                                
                                <!-- Grupo Proveedor -->
                                <div class="mb-3">
                                    <label for="nombres" class="formulario__label">Cliente</label>
                                    <input 
                                        type="text" 
                                        value="${CLS.getNombres()}" 
                                ...
                                <!-- Grupo Telefono -->
                                <div class="mb-3">
                                    <label for="asesor"class="formulario__label">Telefono</label>
                                    <input 
                                        type="text" 
                                        value="${CLS.getTelefono()}" 
                                        class="formulario__input form-control-sm"
                                        id="telefono" 
                                        name="telefono" 
                                        placeholder="Ingrese # Contac">
                                </div>
                                ...
                                <div class="d-md-block text-center" style="grid-column: span 2;">
                                    <button class="btn btn-primary btn-sm" type="submit" name="accion" value="registrarCt2" id="btnAgregar"
                                          data-editing="${isEditing != null && isEditing}">
                                        <i class="fas fa-save"></i> AGREGAR
                                    </button>
                                    <button type="submit" name="accion" value="updateCL" class="btn btn-warning btn-sm" id="btnActualizar"
                                               data-editing="${isEditing != null && isEditing}">
                                        <i class="bi bi-arrow-repeat"></i> ACTUALIZAR
                                    </button>                              

                                    <button class="btn btn-secondary btn-sm" type="submit" name="accion" value="listarCliente">
                ...
                <div class="col-sm-7">
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            <br>
                            <br>
                            <h5 class="text-primary elegant-font text-center"><b>CLIENTES</b></h5>
                            <div class="table-container table-responsive pagination-container shadow-sm p-3 mb-5 bg-white rounded">
                                <table id="myTable" class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <% List<Clientes> Lista2 = (List<Clientes>) request.getAttribute("listarClt2");
                                        for (Clientes cl : Lista2) {%>
                                        <tr style="text-align: center">
                                            ...
                                            <td>
                                                <div class="btn-group text-center" role="group">
                                                    <a href="ControladorFacturaventa?accion=deletCl&id=<%= cl.getId()%>" class="btn btn-outline-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este proveedor?')">
                                                        <i class="fas fa-trash-alt"></i>
                                                    </a>
                                                    <a href="ControladorFacturaventa?accion=editarcliente&id=<%= cl.getId()%>" class="btn btn-outline-primary btn-sm">
